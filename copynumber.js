    ...
    setTimeout(function () {
      ...
      if (newSpanElement) {
        ...
        var newSpanElement = document.querySelector(
          "#app > div._aiwn._aiwm.app-wrapper-web.font-fix.os-win.x1px0edx.xoeyzqq > div > div.x78zum5.xdt5ytf.x5yr21d > div > div._aig-._as6h.x9f619.x1n2onr6.x5yr21d.x6ikm8r.x10wlt62.x17dzmu4.x1i1dayz.x2ipvbc.x1w8yi2h.xpilrb4.x1t7ytsu.x1m2ixmg.x1c4vz4f.x2lah0s.x1oy9qf3.xwfak60.x5hsz1j.x17dq4o0.x10e4vud > span > div > span > div > div > section > div:nth-child(13) > div.x1c1uobl._ajxt > div > div > span > span"
        );
        console.log(newSpanElement);
        var newSearchText = newSpanElement.innerText.trim();
        // Verificar si el texto es un número de teléfono
